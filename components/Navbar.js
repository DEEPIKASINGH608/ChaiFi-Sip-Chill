          ...
          <div className="relative inline-block text-left">
            ...
            {isOpen && (
              <div className="absolute right-0 z-10 mt-2 w-56 origin-top-right rounded-md bg-gray-800 ring-1 ring-white/10 shadow-xl">
                <div className="py-1">
                  <Link href="/dashboard" className="block px-4 py-2 text-sm text-gray-300 hover:bg-white/5 hover:text-white">Dashboard</Link>
                  <Link href="/account" className="block px-4 py-2 text-sm text-gray-300 hover:bg-white/5 hover:text-white">Account settings</Link>
